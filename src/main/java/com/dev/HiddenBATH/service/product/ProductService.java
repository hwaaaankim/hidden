...
public class ProductService {
	...
	public Product productInsert(ProductDTO dto) throws IllegalStateException, IOException {
	    ...
	    String path = commonPath 
	        + "/product/"
	        + productBigSortRepository.findById(dto.getBigSort()).get().getName() 
	        + "/"
	        + productMiddleSortRepository.findById(dto.getMiddleSort()).get().getName()
	        + "/"
	        + dto.getProductCode()
	        + "/"
	        + current_date 
	    ...
	    System.out.println("File road: " + road);
...
//        }
//        String productImageName = generatedString + originalFileExtension;
//		String productImagePath = path + "/representative/" + generatedString + originalFileExtension;
//		String productImageRoad = road + "/representative/" + generatedString + originalFileExtension;
//
//		File productImageSaveFile = new File(productImagePath);	
